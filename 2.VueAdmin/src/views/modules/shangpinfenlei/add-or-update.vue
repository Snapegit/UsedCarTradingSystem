<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#e9ecf3"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="汽车类型" prop="shangpinleixing">
					<el-input v-model="ruleForm.shangpinleixing" placeholder="汽车类型" clearable  :readonly="ro.shangpinleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="汽车类型" prop="shangpinleixing">
					<el-input v-model="ruleForm.shangpinleixing" placeholder="汽车类型" readonly></el-input>
				</el-form-item>
			</template>
